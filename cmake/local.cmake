...
set(OLLAMA_LLAMA_BACKENDS "" CACHE STRING
    "Semicolon-separated llama-server GPU backends to build: cuda_v12;cuda_v13;rocm_v7_1;rocm_v7_2;vulkan;cuda_jetpack5;cuda_jetpack6;opencl")
    ...
    foreach(_backend IN LISTS OLLAMA_LLAMA_BACKENDS)
        ...
        elseif(_backend STREQUAL "opencl")
            ...
            ollama_add_llama_server_build(opencl
                RUNNER_DIR opencl
                TARGETS ggml-opencl
                CMAKE_ARGS ${_opencl_args})
            list(APPEND _backend_targets ollama-llama-server-opencl)
